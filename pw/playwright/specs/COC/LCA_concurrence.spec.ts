...
const xRefTest       = "CON_LCA_CHK";
const xDescription   = "Contrôle d'Accès - SIGALE Concurrence";
const xIdTest        = 7498;
...
import { Authentification }     from '@pom/COC/authentification.page';
...
let pageObjectAuth      : Authentification;
...
test.beforeAll(async ({ browser }, testInfo) => {
    ...
    log                 = new Log();
    pageObjectAuth      = new Authentification(page);
    menu                = new MenuConcurrence(page);
