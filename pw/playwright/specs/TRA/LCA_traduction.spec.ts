...
const xRefTest       = "TRA_LCA_CHK";
const xDescription   = "Contrôle d'Accès - TRADUCTION";
const xIdTest        = 1615;
const xVersion       = '3.0';
...
import { Authentification }                 from '@pom/TRA/authentification.page';
