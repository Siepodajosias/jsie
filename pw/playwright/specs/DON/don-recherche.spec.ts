 ...
 *  
 */
const xRefTest      = "DON_DET_RDO";
const xDescription  = "Recherche d'un DON";
const xIdTest       = 4712;
...
var info:CartoucheInfo = {
	...
	idTest      : xIdTest,
	help        : [],
	params      : ['societeDonatrice', 'beneficiaire','montant'],
	fileName    : __filename
}
...
test.describe.serial ('[' + xRefTest + ']', () => {
	...
	test.describe('Page [DONS]', async () => {
		...
		test.describe('Onglet [' + sNomOnglet + ']',async () => {
			...
			var nNomCasdeTest:string = 'RECHERCHER UN DON';
			test.describe('[' + nNomCasdeTest + ']',async () => {
				...
				test('Column [DATE][0] = "' + sDateDuJour + '" - Check', async () => {
				...
				test('Column [VALORISATION][0] = "' + iMontantDon + '" - Check', async () => {
