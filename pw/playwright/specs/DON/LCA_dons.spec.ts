...
const xRefTest       = "DON_LCA_CHK";
const xDescription   = "Contrôle d'Accès - SIGALE Dons";
const xIdTest        = 4961;
const xVersion       = '3.0';
...
import { Authentification }                 from '@pom/DON/authentification.page';
