...
const xRefTest       = "BUD_LCA_CHK";
const xDescription   = "Contrôle d'Accès - SIGALE Budgets";
const xIdTest        = 4954;
const xVersion       = '3.1';
...
import { Authentification }                 from '@pom/BUD/authentification.page';
