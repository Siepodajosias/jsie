...
test.describe.serial ('[' + xRefTest + ']', () => {
	...
	test.describe ('Page [ACCUEIL]', async() => {
        ...
        test ('Page [ACCUEIL] - Click ', async () => {
			await menuPage.click('accueil', page);
		})

		test ('DataGrid [TH][0] Is Vivisble', async () => {           
			await fonction.isDisplayed(menuPage.tableRecapitulatif.first());
		})
		...
		test.skip ('ListBox [RAYON] = "' + sRayon + '"', async () => {            
			await menuPage.selectRayon(sRayon, page, 60000);                              // Sélection du rayon
		})

		test.skip (' DataGrid [RECAPITULATIF] - Check', async () => {
	...
	test.describe.skip ('** Check Statut répartition **', async () => {
	...
	test.describe.skip ('Page [LOTS]', async () => {
	...
	test.describe.skip ('Page [ARTICLES]', async () => {  
	...
	test.describe.skip ('Page [REPARTITION]', async () => { 
	...
	test.describe.skip ('Page [ORDRES REPARTITION]', async ()  => {    
	...
	test.describe.skip ('Page [REFERENTIEL]', async ()  => {    
	...
	test.describe.skip ('Page [ADMIN]', async ()  => {    
