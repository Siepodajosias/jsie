...
const xRefTest      = "QUA_MOB_AEM";
const xDescription  = "Gerer Les Elements AFL";
const xIdTest       =  6640;
const xVersion      = '3.0';
...
test.describe.serial ('[' + xRefTest + ']', async () =>  {
    ...
    test.describe ('Page [' + sNomPage.toUpperCase() + ']', async () => {
		...
		test.describe ('Onglet [' + sNomOnglet.toUpperCase() + ']', async () =>  {
            ...
            var sNomPopin:string = 'Gestion des éléments pour ' + sLieudeVente;
            ...
            test.describe ('Popin [' + sNomPopin.toUpperCase() + ']', async () => {
                ...
                test ('Button [AJOUTER_ELEMENT - RAYON COTE FL][4] - Click', async () => { 
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(0));
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(0));
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(0));
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(0));
                }) 

                test ('Button [AJOUTER_ELEMENT - RAYON U][1] - Click', async () => {
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(1));
                })

                test ('Button [AJOUTER_ELEMENT - RAYON COTE MUR][1] - Click', async () => { 
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(2));
                })

                test ('Button [AJOUTER_ELEMENT - RAYON COUPE][1] - Click', async () => { 
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(3));
                })
            
                test ('Button [AJOUTER_ELEMENT - ARTEMIS/TG][1] - Click', async () => { 
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(4));
                })
                
                test ('Button [AJOUTER_ELEMENT - CHAMBRE FROIDE][1] - Click', async () => { 
                    await fonction.clickElement(pageReferentielMobiliers.pPGelbuttonAjouterElements.nth(5));
                })

                test ('Button [ENREGISTRER] - Click', async () => {  
                    await fonction.clickAndWait(pageReferentielMobiliers.pPGelbuttonEnregistrer, page);
                }) 
