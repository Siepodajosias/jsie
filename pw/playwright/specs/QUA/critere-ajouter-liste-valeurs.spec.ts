...
const xDescription  = "TA Ajouter un critère de type liste de valeurs";
const xIdTest       =  6662;
const xVersion      = '3.0';
...
const sNomQuestionnaire                    = fonction.getInitParam('nomQuestionnaire', 'TA_QuestionnaireTypeValeurs_'+ fonction.getToday());
...
const sTypeCritere                         = fonction.getInitParam('typeCritere', 'Liste des valeurs');
		...
		test.describe ('Onglet [' + sNomOnglet.toUpperCase() + ']', async () =>  {
            ...
            test.describe ('Popin [' + sNomPopin.toUpperCase() + '] #2', async () => {
                ...
                test ('InputField  [CODE CRITERE] = "CRI0245"', async () => {                   
                    await fonction.sendKeys(pageReferentielDetailQuestion.pPAcInputCodeCritere,'CRI0245', false, 'Code Critere'); //CRI0245
                })
