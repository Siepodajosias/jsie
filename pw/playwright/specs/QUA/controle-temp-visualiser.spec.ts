...
const xRefTest      = "QUA_TMP_VCT";
const xDescription  = "Visualiser un contrôle Température";
const xIdTest       =  6636;
const xVersion      = '3.0';
    ...
    test.describe ('Page [CONTROLE]', async () => {
        ...
        test.describe ('Onglet[' + sNomOnglet.toUpperCase() + ']', async () =>  {
            ...
            test.describe('Popin [' + sNomPopin.toUpperCase() + ']', async () => {
                ...
                test ('Button [VISUALISER CONTROLE] - Click', async () => {
                    await fonction.clickElement(pageControlesTemperatures.buttonVisualiserControle);
                })  
                
                test ('Popin [' + sNomPopin.toUpperCase() + '] - Is Visible', async () => {
                    await fonction.popinVisible(page, sNomPage, true);
                })
                      
                test ('Button [FERMER] - Click', async () => {
                    await fonction.clickElement(pageControlesTemperatures.pPCecButtonFermer);
                })  
                
                test ('Popin [' + sNomPopin.toUpperCase() + '] - Is Not Visible', async () => {
                    await fonction.popinVisible(page, sNomPage, false);
                })
