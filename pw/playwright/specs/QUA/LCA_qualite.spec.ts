...
const xRefTest       = "QUA_LCA_CHK";
const xDescription   = "Contrôle d'Accès - SIGALE Qualité";
const xIdTest        = 5858;
const xVersion       = '3.1';
...
import { Authentification }                 from '@pom/QUA/authentification.page';
